...
const Navbar = () => {
  ...
  return (
    ...
    <div className='bg-blue-500 flex items-center p-2 justify-between'>
        ...
        {isLoggedIn && <div className='flex items-center gap-6 text-white'>
            <div className='flex items-center gap-2'>
            <img className='w-10 rounded-full' src={loggedInUser.avatar} alt="" />
            <p>{loggedInUser.username}</p>
            </div>
            <button className='text-white mx-2' onClick={logoutUser}>Logout</button>
            </div>}
